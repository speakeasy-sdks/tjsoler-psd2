...
type InitiationPaymentPathParamPaymentProduct string

const (
	InitiationPaymentPathParamPaymentProductSepaCreditTransfers        InitiationPaymentPathParamPaymentProduct = "sepa-credit-transfers"
	InitiationPaymentPathParamPaymentProductInstantSepaCreditTransfers InitiationPaymentPathParamPaymentProduct = "instant-sepa-credit-transfers"
	InitiationPaymentPathParamPaymentProductTarget2Payments            InitiationPaymentPathParamPaymentProduct = "target-2-payments"
	InitiationPaymentPathParamPaymentProductCrossBorderCreditTransfers InitiationPaymentPathParamPaymentProduct = "cross-border-credit-transfers"
)

func (e InitiationPaymentPathParamPaymentProduct) ToPointer() *InitiationPaymentPathParamPaymentProduct {
	return &e
}

func (e *InitiationPaymentPathParamPaymentProduct) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "cross-border-credit-transfers":
		*e = InitiationPaymentPathParamPaymentProduct(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InitiationPaymentPathParamPaymentProduct: %v", v)
	}
}

type InitiationPaymentRequest struct {
	...
	SinglePayment shared.SinglePayment `request:"mediaType=application/json"`
	...
	PaymentProduct InitiationPaymentPathParamPaymentProduct `pathParam:"style=simple,explode=false,name=payment-product"`
}
...
func (o *InitiationPaymentRequest) GetDigest() string {
	if o == nil {
		return ""
	}
	return o.Digest
...
func (o *InitiationPaymentRequest) GetPSUAccept() *string {
	if o == nil {
		return nil
	}
	return o.PSUAccept
...
func (o *InitiationPaymentRequest) GetPSUAcceptCharset() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetPSUAcceptEncoding() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetPSUAcceptLanguage() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetPSUCorporateID() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetPSUCorporateIDType() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetPSUDeviceID() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetPSUGeoLocation() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetPSUHTTPMethod() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetPsuID() *string {
	if o == nil {
		return nil
	}
	return o.PsuID
...
func (o *InitiationPaymentRequest) GetPSUIDType() *string {
	if o == nil {
		return nil
	}
	return o.PSUIDType
...
func (o *InitiationPaymentRequest) GetPSUIPAddress() string {
	if o == nil {
		return ""
	}
...
func (o *InitiationPaymentRequest) GetPSUIPPort() *string {
	if o == nil {
		return nil
	}
	return o.PSUIPPort
...
func (o *InitiationPaymentRequest) GetPSUUserAgent() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetSignature() string {
	if o == nil {
		return ""
	}
	return o.Signature
...
func (o *InitiationPaymentRequest) GetSinglePayment() shared.SinglePayment {
	if o == nil {
		return shared.SinglePayment{}
	}
	return o.SinglePayment
}

func (o *InitiationPaymentRequest) GetTPPBrandLoggingInformation() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetTPPExplicitAuthorisationPreferred() *bool {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetTPPNokRedirectURI() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetTPPNotificationContentPreferred() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetTPPNotificationURI() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetTPPRedirectPreferred() *bool {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetTPPRedirectURI() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetTPPRejectionNoFundsPreferred() *string {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentRequest) GetTPPSignatureCertificate() string {
	if o == nil {
		return ""
	}
...
func (o *InitiationPaymentRequest) GetXRequestID() string {
	if o == nil {
		return ""
	}
	return o.XRequestID
...
func (o *InitiationPaymentRequest) GetAspsp() string {
	if o == nil {
		return ""
	}
	return o.Aspsp
...
func (o *InitiationPaymentRequest) GetPaymentProduct() InitiationPaymentPathParamPaymentProduct {
	if o == nil {
		return InitiationPaymentPathParamPaymentProduct("")
	}
	return o.PaymentProduct
}

type InitiationPaymentResponse struct {
...
func (o *InitiationPaymentResponse) GetContentType() string {
	if o == nil {
		return ""
	}
...
func (o *InitiationPaymentResponse) GetHeaders() map[string][]string {
	if o == nil {
...
func (o *InitiationPaymentResponse) GetResponsePaymentInitiation() *shared.ResponsePaymentInitiation {
	if o == nil {
		return nil
	}
...
func (o *InitiationPaymentResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *InitiationPaymentResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
