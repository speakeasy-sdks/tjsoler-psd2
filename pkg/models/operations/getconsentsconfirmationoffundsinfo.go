...
type GetConsentsConfirmationOfFundsInfoRequest struct {
...
func (g GetConsentsConfirmationOfFundsInfoRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetConsentsConfirmationOfFundsInfoRequest) UnmarshalJSON(data []byte) error {
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetDigest() string {
	if o == nil {
		return ""
	}
	return o.Digest
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUAccept() *string {
	if o == nil {
		return nil
	}
	return o.PSUAccept
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUAcceptCharset() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUAcceptEncoding() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUAcceptLanguage() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUDeviceID() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUGeoLocation() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUHTTPMethod() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUIPAddress() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUIPPort() *string {
	if o == nil {
		return nil
	}
	return o.PSUIPPort
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetPSUUserAgent() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetSignature() string {
	if o == nil {
		return ""
	}
	return o.Signature
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetTPPNokRedirectURI() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetTPPRedirectPreferred() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetTPPRedirectURI() *string {
	if o == nil {
		return nil
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetTPPSignatureCertificate() string {
	if o == nil {
		return ""
	}
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetXRequestID() string {
	if o == nil {
		return ""
	}
	return o.XRequestID
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetAspsp() string {
	if o == nil {
		return ""
	}
	return o.Aspsp
...
func (o *GetConsentsConfirmationOfFundsInfoRequest) GetConsentID() string {
	if o == nil {
		return ""
	}
	return o.ConsentID
...
type GetConsentsConfirmationOfFundsInfoResponse struct {
	Body []byte
...
func (o *GetConsentsConfirmationOfFundsInfoResponse) GetBody() []byte {
	if o == nil {
		return nil
	}
	return o.Body
...
func (o *GetConsentsConfirmationOfFundsInfoResponse) GetContentType() string {
	if o == nil {
		return ""
	}
...
func (o *GetConsentsConfirmationOfFundsInfoResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *GetConsentsConfirmationOfFundsInfoResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
