...
type PostConsentsRequest struct {
	...
	// Accesos solicitados a los servicios. Solo los sub atributos con tags “accounts”, “balances” y “transactions” son aceptados. Adicionalmente el ASPSP puede soportar los sub atributos "availableAccounts" o "allPsd2" con valor “all-accounts”.
...
func (p PostConsentsRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(p, "", false)
}

func (p *PostConsentsRequest) UnmarshalJSON(data []byte) error {
...
func (o *PostConsentsRequest) GetDigest() string {
	if o == nil {
		return ""
	}
	return o.Digest
...
func (o *PostConsentsRequest) GetPSUAccept() *string {
	if o == nil {
		return nil
	}
	return o.PSUAccept
...
func (o *PostConsentsRequest) GetPSUAcceptCharset() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetPSUAcceptEncoding() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetPSUAcceptLanguage() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetPSUCorporateID() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetPSUCorporateIDType() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetPSUDeviceID() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetPSUGeoLocation() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetPSUHTTPMethod() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetPsuID() *string {
	if o == nil {
		return nil
	}
	return o.PsuID
...
func (o *PostConsentsRequest) GetPSUIDType() *string {
	if o == nil {
		return nil
	}
	return o.PSUIDType
...
func (o *PostConsentsRequest) GetPSUIPAddress() string {
	if o == nil {
		return ""
	}
...
func (o *PostConsentsRequest) GetPSUIPPort() *string {
	if o == nil {
		return nil
	}
	return o.PSUIPPort
...
func (o *PostConsentsRequest) GetPSUUserAgent() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetRequestBody() []byte {
	if o == nil {
		return []byte{}
	}
...
func (o *PostConsentsRequest) GetSignature() string {
	if o == nil {
		return ""
	}
	return o.Signature
...
func (o *PostConsentsRequest) GetTPPBrandLoggingInformation() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetTPPNokRedirectURI() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetTPPRedirectPreferred() *bool {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetTPPRedirectURI() *string {
	if o == nil {
		return nil
	}
...
func (o *PostConsentsRequest) GetTPPSignatureCertificate() string {
	if o == nil {
		return ""
	}
...
func (o *PostConsentsRequest) GetXRequestID() string {
	if o == nil {
		return ""
	}
	return o.XRequestID
...
func (o *PostConsentsRequest) GetAspsp() string {
	if o == nil {
		return ""
	}
	return o.Aspsp
...
type PostConsentsResponse struct {
	Body []byte
...
func (o *PostConsentsResponse) GetBody() []byte {
	if o == nil {
		return nil
	}
	return o.Body
...
func (o *PostConsentsResponse) GetContentType() string {
	if o == nil {
		return ""
	}
...
func (o *PostConsentsResponse) GetHeaders() map[string][]string {
	if o == nil {
		return nil
	}
	return o.Headers
...
func (o *PostConsentsResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *PostConsentsResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
