...
func (s *LecturaDeDetallesDeCuenta) GetAccountIdv11(ctx context.Context, request operations.GetAccountIdv11Request) (*operations.GetAccountIdv11Response, error) {
	hookCtx := hooks.HookContext{OperationID: "getAccountIdv11"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api-entrada-xs2a/services/{aspsp}/v1.1/accounts/{account-id}", request, nil)
	if err != nil {
	...
	res := &operations.GetAccountIdv11Response{
